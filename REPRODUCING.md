...
the software permission boundary defined by Machine Permission Test v0.4.
...
- `machine-permission-test.evidence.json`: results for MPT-001 through MPT-020;
...
A PASS means the tested source enforced all twenty software assertions, including
