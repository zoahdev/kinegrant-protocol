...
>
> **Reference implementation v2.11.0 · Apache-2.0**
>
...
## Security properties implemented in reference implementation v2.11.0
...
- A standalone, offline [browser policy-bundle verifier](verify/policy-bundle-verifier.html)
  ...
  reports, plus receipt evidence packets, entirely in the browser (zero
...
- Stable wire format: the reference implementation issues and verifies `1.0`
  ...
  scoped capabilities. Reference implementation version is now `2.11.0`.
