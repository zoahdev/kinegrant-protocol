...
>
> **Reference implementation v2.6.0 · Apache-2.0**
>
...
## Security properties implemented in reference implementation v2.6.0
...
- A standalone, offline [browser policy-bundle verifier](verify/policy-bundle-verifier.html)
  ...
  receipt chains entirely in the browser (zero dependencies; host `verify/`
...
- Stable wire format: the reference implementation issues and verifies `1.0`
  ...
  scoped capabilities. Reference implementation version is now `2.6.0`.
