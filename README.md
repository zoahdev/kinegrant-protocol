...
>
> **Reference implementation v1.1.0 · Apache-2.0**
>
...
## Security properties implemented in reference implementation v1.1.0
...
- Obligations are enforced after execution: `ObligationCompliance` checks that
  ...
  `revocation_distribution` marks (20/20), and the micro-benchmarks include
  obligation compliance and revocation-distribution throughput.
...
- Stable wire format: the reference implementation issues and verifies `1.0`
  ...
  scoped capabilities. Reference implementation version is now `1.1.0`.
