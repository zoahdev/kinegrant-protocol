...
>
> **Reference implementation v2.59.0 · Apache-2.0**
>
...
## Security properties implemented in reference implementation v2.59.0
...
- Stable wire format: the reference implementation issues and verifies `1.0`
  ...
  scoped capabilities. Reference implementation version is now `2.59.0`.
