...
>
> **Reference implementation v2.34.0 · Apache-2.0**
>
...
## Security properties implemented in reference implementation v2.34.0
...
- A standalone, offline [browser policy-bundle verifier](verify/policy-bundle-verifier.html)
  ...
  anywhere and link the page), plus gateway robot demo reports.
- Stable wire format: the reference implementation issues and verifies `1.0`
  ...
  scoped capabilities. Reference implementation version is now `2.34.0`.
