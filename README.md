...
>
> **Reference implementation v1.0.1 · Apache-2.0**
>
...
## Security properties implemented in reference implementation v1.0.1
...
- Stable wire format: the reference implementation issues and verifies `1.0`
  ...
  scoped capabilities. Reference implementation version is now `1.0.1`.
